package com.example.domainlogictest.domain.repository;

import android.content.Context;

import com.example.domainlogictest.domain.model.User;
import com.example.domainlogictest.domain.repository.cachepolicy.CachePolicy;
import com.example.domainlogictest.domain.repository.cachepolicy.NoCachePolicy;
import com.example.domainlogictest.domain.repository.cachepolicy.TimedCachePolicy;
